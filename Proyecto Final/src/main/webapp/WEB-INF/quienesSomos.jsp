        ...
        <div class="row row-cols-2">
          <div class="col">
                <h1 class="titulo">Quienes Somos</h1>
                    <p>
                    En Second Chance somos un equipo de programadores con el objetivo de desarrollar una pagina que se dedique a la adopcion segura, 
